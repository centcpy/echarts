(function () {
    ...
    var SZData = [
        [{ name: '苏州' }, { name: '成都', value: 100 }],
        [{ name: '苏州' }, { name: '厦门', value: 100 }],
        [{ name: '苏州' }, { name: '郑州', value: 100 }],
    ...
    var series = [];
    [['西安', XAData], ['西宁', XNData], ['银川', YCData], ['厦门', XMData], ['郑州', ZZData], ['苏州', SZData]].forEach(function (item, i) {
        series.push({
            name: item[0] + ' Top3',
            type: 'lines',
            zlevel: 1,
